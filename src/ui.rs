...
impl UI {
    ...
    fn get_request(&self, url: String, header: String) {
        crate::ui_interface::get_request(url, header)
    }
    ...
    fn test_get_request(&self, url: String) {
        crate::ui_interface::test_get_request(url)
    }

    fn get_test_async_job_status(&self) -> String {
        crate::ui_interface::get_test_async_job_status()
    }
...
impl sciter::EventHandler for UI {
    sciter::dispatch_script_call! {
        ...
        fn test_get_request(String);
        fn get_test_async_job_status();
